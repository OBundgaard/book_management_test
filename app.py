...
app = Flask(__name__)
books = {1: Book(book_id=1, title='Sample book', author='Sample author', published_date='1970-1-1'),
         ...
         4: Book(book_id=3, title='Sample book', author='Sample author', published_date='1970-1-1')}
